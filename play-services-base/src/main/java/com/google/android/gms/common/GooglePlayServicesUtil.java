...
public class GooglePlayServicesUtil {
     ...
     */
    @Deprecated
    public static Dialog getErrorDialog(int requestCode) {
     ...
     * {@link #getErrorDialog(int)} and showing the dialog.
     *
     * @return true if the error is recoverable with {@link #getErrorDialog(int)}
     */
    @Deprecated
    ...
    /**
     * Display a DialogFragment for an error code returned by {@link #isGooglePlayServicesAvailable()}.
     *
     * @param requestCode The requestCode given when calling startActivityForResult.
     ...
     */
    @Deprecated
    public static boolean showErrorDialogFragment(int requestCode) {
        return showErrorDialogFragment();
    }

    @Deprecated
    public static boolean showErrorDialogFragment(Fragment fragment) {
        return false; // TODO
    }
    ...
    public static boolean showErrorDialogFragment() {
        return showErrorDialogFragment(null);
    }

    /**
     * Displays a notification relevant to the provided error code. This method is similar to
     * {@link #getErrorDialog(int)}, but is provided for background
